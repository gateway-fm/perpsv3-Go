...
// GetCollateralPrice is a free data retrieval call binding the contract method 0x8010af04.
//
// Solidity: function getCollateralPrice(address collateralType, uint256 collateralAmount) view returns(uint256)
func (_Core *CoreCaller) GetCollateralPrice(opts *bind.CallOpts, collateralType common.Address, collateralAmount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Core.contract.Call(opts, &out, "getCollateralPrice", collateralType, collateralAmount)
...
//
// Solidity: function getCollateralPrice(address collateralType, uint256 collateralAmount) view returns(uint256)
func (_Core *CoreSession) GetCollateralPrice(collateralType common.Address, collateralAmount *big.Int) (*big.Int, error) {
	return _Core.Contract.GetCollateralPrice(&_Core.CallOpts, collateralType, collateralAmount)
}

// GetCollateralPrice is a free data retrieval call binding the contract method 0x8010af04.
//
// Solidity: function getCollateralPrice(address collateralType, uint256 collateralAmount) view returns(uint256)
func (_Core *CoreCallerSession) GetCollateralPrice(collateralType common.Address, collateralAmount *big.Int) (*big.Int, error) {
	return _Core.Contract.GetCollateralPrice(&_Core.CallOpts, collateralType, collateralAmount)
}
...
func (_Core *CoreCaller) GetPositionCollateral(opts *bind.CallOpts, accountId *big.Int, poolId *big.Int, collateralType common.Address) (struct {
	Amount *big.Int
	Value  *big.Int
}, error) {
	var out []interface{}
...
//
// Solidity: function getPositionCollateral(uint128 accountId, uint128 poolId, address collateralType) view returns(uint256 amount, uint256 value)
func (_Core *CoreSession) GetPositionCollateral(accountId *big.Int, poolId *big.Int, collateralType common.Address) (struct {
	Amount *big.Int
	Value  *big.Int
}, error) {
...
//
// Solidity: function getPositionCollateral(uint128 accountId, uint128 poolId, address collateralType) view returns(uint256 amount, uint256 value)
func (_Core *CoreCallerSession) GetPositionCollateral(accountId *big.Int, poolId *big.Int, collateralType common.Address) (struct {
	Amount *big.Int
	Value  *big.Int
}, error) {
	return _Core.Contract.GetPositionCollateral(&_Core.CallOpts, accountId, poolId, collateralType)
...
func (_Core *CoreTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _Core.contract.Transact(opts, "multicall", data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) payable returns(bytes[] results)
func (_Core *CoreSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Core.Contract.Multicall(&_Core.TransactOpts, data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) payable returns(bytes[] results)
func (_Core *CoreTransactorSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Core.Contract.Multicall(&_Core.TransactOpts, data)
}
